    ...
    def esperar5(self):
        while self.define:
            try:
                ...
                self.temp_val.set(leer['temp_val'])
                self.pulso_val.set(leer['pulso_val'])
                self.hr_val.set(leer['hr_val'])
                self.spo_val.set(leer['spo_val'])
                self.resp_val.set(leer['resp_val'])
                self.presion_val.set(leer['presion_val'])
                a = np.asarray(leer['y'])
                #a[a==-1] = None
